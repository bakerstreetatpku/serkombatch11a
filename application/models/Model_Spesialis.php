<?php
  class Model_Spesialis extends CI_Model {
  	...
  	var $table = 'srk_spesialis';
	var $column_order = array('sps_nama'); //set column field database for datatable orderable
	var $column_search = array('sps_nama', "sps_gelar"); //set column field database for datatable searchable just firstname , lastname , address are searchable
	var $order = array('sps_nama' => 'asc'); // default order  	private $db_sts;
	...
	{	$this->db->from("srk_jabatan");
		$this->db->where("jab_jenis","Spesialis");
		$query = $this->db->get();
	...
	public function get_spesialis($id)
