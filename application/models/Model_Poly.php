<?php
  class Model_Poly extends CI_Model {
  
  	var $table = 'srk_poly';
	var $column_order = array('ply_nama'); //set column field database for datatable orderable
	var $column_search = array('ply_nama', "ply_kode"); //set column field database for datatable searchable just firstname , lastname , address are searchable
	var $order = array('ply_nama' => 'asc'); // default order  	private $db_sts;
